...
def test_cls(estim_algorithm, mode, metric, logits_tests, gt_tests, dataset, portion, seednum):
    ...
    ckpt_savname = f"./{dataset}_{mode}_{metric}_{estim_algorithm}_{portion}_seed{seednum}_batch.pkl"
...
def main():
    ...
    for seednum in seednums:
        ...
        results_files = args.savingpath[:-4] + "seed" + str(seednum) + "_batch.txt"
