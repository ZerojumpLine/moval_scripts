...
cmd_eval = bin + ' /well/win-fmrib-analysis/users/gqu790/moval/moval_scripts/eval_seg2d_cardiac.py --dataset {dataset} --predpath {predpath} --gtpath {gtpath} --savingpath {savingpath} \n'
