...
cmd_estim = bin + ' /well/win-fmrib-analysis/users/gqu790/moval/moval_scripts/src/estimation/estim_seg3d_ensemble_ablation.py --dataset {dataset} --predpath {predpath} --metric {metric} --gtpath {gtpath} --portion {portion}\n'
cmd_eval = bin + ' /well/win-fmrib-analysis/users/gqu790/moval/moval_scripts/src/evaluation/eval_seg3d_brainlesion_ensemble_ablation.py --dataset {dataset} --predpath {predpath} --gtpath {gtpath} --metric {metric} --savingpath {savingpath} --portion {portion}\n'
