...
cmd_estim = bin + ' /well/win-fmrib-analysis/users/gqu790/moval/moval_scripts/src/estimation/estim_cls_ensemble_ablation_batch.py --dataset {dataset} --numcls {numcls} --metric {metric} --valpath {valpath} --portion {portion}\n'
cmd_eval = bin + ' /well/win-fmrib-analysis/users/gqu790/moval/moval_scripts/src/evaluation/eval_cls_cifar10_ensemble_ablation_batch.py --dataset {dataset} --testpath {testpath} --metric {metric} --savingpath {savingpath} --portion {portion}\n'
